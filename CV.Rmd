...
aboutme: "Experienced Bioinformatics Data Engineer with 3+ years of expertise in designing scalable ETL pipelines, integrating large-scale biological datasets, and building robust data infrastructure to support cutting-edge research. Proven track record in establishing best practices for data architecture, collaborating cross-functionally to align systems with analytical goals, and driving innovative solutions for biological discovery and therapeutic development."
headcolor: 414141
output: 
  vitae::awesomecv
---
...
tribble(
   ...
   ~`Databases`,
  "Debian, Ubuntu, Fedora Red Hat Linux, Raspbian Linux, Windows 11",
  "Python, R, Bash, SQL",
  ...
  "PySpark, Tensorflow, Pytorch, scikit-learn, scipy",
